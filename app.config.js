export default {
  expo: {
    ...
    extra: {
      ...
      API_POST_FIX: process.env.EXPO_PUBLIC_API_POST_FIX,
      API_TIMEOUT: process.env.EXPO_PUBLIC_API_TIMEOUT,
      APP_ENV: process.env.EXPO_PUBLIC_APP_ENV,
      AUTH_ISSUER_URL: process.env.EXPO_PUBLIC_AUTH_ISSUER_URL,
      AUTH_CLIENT_ID: process.env.EXPO_PUBLIC_AUTH_CLIENT_ID,
      AUTH_CLIENT_SECRET: process.env.EXPO_PUBLIC_AUTH_CLIENT_SECRET,
      AUTH_AUTH_REDIRECT_URI: process.env.EXPO_PUBLIC_AUTH_REDIRECT_URI,
