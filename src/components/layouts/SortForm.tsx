...
import { SortDirection } from "@/src/constants/global";
...
const SortForm = ({ sort, setSort, params }: SortFormProps) => {
        ...
        {Object.keys(params || {}).map((key) => (
          <>
            ...
            <View style={styles.SortButtons}>
              <ButtonView
                variant={
                  isSortActive(key, SortDirection.ASC) ? "primary" : "outline"
                }
                size="small"
                style={styles.SortButton}
                textStyle={[
                  styles.SortButtonText,
                  isSortActive(key, SortDirection.ASC) &&
              ...
              <ButtonView
                variant={
                  isSortActive(key, SortDirection.DESC) ? "primary" : "outline"
                }
                size="small"
                style={styles.SortButton}
                textStyle={[
                  styles.SortButtonText,
                  isSortActive(key, SortDirection.DESC) &&
                    styles.selectedSortButtonText,
                ]}
                onPress={() =>
                  onChangeSort({
