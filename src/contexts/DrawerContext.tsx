...
export const DrawerProvider: React.FC<DrawerProviderProps> = ({
  ...
  const openDrawer = useCallback(
    (id: string, content: ReactNode, drawerConfig?: Partial<DrawerConfig>) => {
      setDrawers((prev) => {
  ...
  const updateDefaultConfig = useCallback(
    (newConfig: Partial<DrawerConfig>) => {
  ...
  const closeDrawerWithAnimation = useCallback(
    (id: string, customConfig?: Partial<DrawerConfig>) => {
