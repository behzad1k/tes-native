...
export const CarIcon = ({ size = 28, color = "#D4D4B0" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      ...
      strokeLinejoin="round"
    />
    <Rect x="2" y="14" width="20" height="5" rx="2" stroke={color} strokeWidth="1.5" />
...
export const BusIcon = ({ size = 28, color = "#D4D4B0" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Rect x="6" y="12" width="3" height="3" rx="0.5" stroke={color} strokeWidth="1" />
    <Rect x="15" y="12" width="3" height="3" rx="0.5" stroke={color} strokeWidth="1" />
  </Svg>
);
...
export const VanIcon = ({ size = 28, color = "#D4D4B0" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M2 7H15V17H2V7Z" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
    <Path d="M15 10H19L22 13V17H15V10Z" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
...
export const PedestrianIcon = ({ size = 28, color = "#D4D4B0" }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M12 12L8 20" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    <Path d="M12 12L16 20" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    <Path d="M8 9L12 10L16 9" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

// Map classification name -> icon component
...
export const getVehicleIcon = (classificationName: string): React.FC<IconProps> => {
  return VEHICLE_ICON_MAP[classificationName] || CarIcon;
};
